...
class ScopeApp:
    def __init__(self, root):
        ...
        self.button_font = tkfont.Font(family="Yu Gothic UI Semilight", size ="8")
        ...
        for r in range(4):
            self.system_frame.grid_rowconfigure(r, weight=1)
        ...
        self.ip_input.grid(column=2, row=0, padx=5, pady=(2, 5), ipadx=40)
        self.lbl_scpi.grid(column=2, row=0, padx=(65,0), pady=(0, 45), sticky="w") # sticky="w" aligns it left
        self.btn_connect.grid(column=0 , row = 0,padx=5, pady=5 , ipadx = 5 , ipady = 5)
        self.btn_disconnect.grid(column=1 , row = 0 ,padx= 5 ,pady = 5 ,ipadx = 5 , ipady = 5)
        self.btn_sendcmd.grid(column=3,row=0,pady=5,ipadx = 5 , ipady = 5)
